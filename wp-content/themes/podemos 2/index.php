...
<div id="page" class="home-page">
	<div class="content">
		<div class="article">
			<!--<h3 class="frontTitle"><div class="latest"><?php _e('Últimos','mythemeshop'); ?></div></h3>-->
			...
			<?php } else { ?>
				<div class="pagination">
					<ul>
						...
						<li class="nav-next"><?php previous_posts_link( __( 'Entradas antiguas'.' &rarr;', 'mythemeshop' ) ); ?></li>
					</ul>
				</div>
			<?php } wp_reset_query(); ?>
			<!--End Pagination-->			
