...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: PODEMOS POINT WL SOCIALTEIGGER
	Description: Muestra los iconos de las redes sociales en el pie de página y en menu lateral
	Version: BETA
...
class Social_Profile_Icons_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Mostrar iconos de perfiles sociales.', 'mythemeshop' ),
		);
		...
		$this->WP_Widget( 'social-profile-icons', __( 'PODEMOS POINT WL. Iconos de redes sociales', 'mythemeshop' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Titulo:', 'mythemeshop' ); ?></label> <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" /></p>
