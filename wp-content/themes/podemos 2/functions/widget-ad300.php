...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: PODEMOS 300x250 BANNER
	Description: Un widget de banner 300 x 250
	Version: BETA
...
function mts_ad_300_Widget() {
	...
	$widget_ops = array(
		...
		'description' => __('Un widget de banner 300 x 250 (Banner simples)', 'mythemeshop')
	);
	...
	// Create the widget
	$this->WP_Widget( 'mts_ad_300_widget', __('PODEMOS: 300x250 Banner', 'mythemeshop'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad' ); ?>"><?php _e('Añade una imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e('Añade un enlace en esa imagen:', 'mythemeshop') ?></label>
