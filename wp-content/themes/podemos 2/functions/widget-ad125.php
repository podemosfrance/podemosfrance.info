...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: PODEMOS 125x125 BANNER
	Description: Un widget de banner 125 x 125 (max 6 banners)
	Version: BETA
...
function mts_Ad_Widget() {
	...
	$widget_ops = array (
		...
		'description' => __('Un widget de banner 125 x 125 (max 6 banners)', 'mythemeshop')
	);
	...
	// Create the widget
	$this->WP_Widget( 'mts_ad_widget', __('PODEMOS: 125x125 Banner', 'mythemeshop'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Añade la 1º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Añade 1 un enlace a la imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Añade la 2º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Añade el enlace de la 2º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Añade la 3º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Añade el enlace de la 3º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Añade la 4º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Añade el enlace de la 4º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Añade la 5º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Añade el enlace de la 5º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Añade la 6º imagen:', 'mythemeshop') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Añade el enlace de la 6º imagen:', 'mythemeshop') ?></label>
	...
	<!-- Randomize? -->
	<p>
		<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('¿Selecciona el orden aleatorio para los banners?', 'mythemeshop') ?></label>
