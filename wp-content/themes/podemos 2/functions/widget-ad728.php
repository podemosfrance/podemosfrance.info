...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: PODEMOS 728x90 BANNER
	Description: Un widget de banner 728 x 90 px
	Version: BETA
...
function mts_ad_728_Widget() {
	...
	$widget_ops = array(
		...
		'description' => __('Un widget de banner 728 x 90 px (Single banner)', 'mythemeshop')
	);
	...
	// Create the widget
	$this->WP_Widget( 'mts_ad_728_widget', __('PODEMOS 728x90 BANNER', 'mythemeshop'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => '',
		'ad' => get_template_directory_uri()."/images/728x90.gif",
