...
<?php }else{ ?>
	<link rel="icon" href="<?php echo site_url(); ?>/wp-content/themes/podemos/favicon.png" type="image/x-icon" />
<?php } ?>
...
<!------------[ Webfonts ]------------->
<link href='http://fonts.googleapis.com/css?family=PT+Serif|Montserrat|Lato' rel='stylesheet' type='text/css'>
<?php }
}
/*------------[ Head ]-------------*/
