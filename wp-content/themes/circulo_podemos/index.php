...
<section id="main_content" role="main">
	<div class="container">
		<section class="call_to_action">
			<div><a class="circulo icon cooperate" href="/participe" title="Participe"></a><h2><a href="#" rel="nofollow" title="Participe">Participe</a></h2></div>
			<div><a class="circulo icon date" href="/evenements" title="Évènements"></a><h2><a href="#" rel="nofollow" title="Évènements">Évènements</a></h2></div>
			<div><a class="circulo icon comission" href="/commissions" title="Commissions"></a><h2><a href="#" rel="nofollow" title="Commissions">Commissions</a></h2></div>
			<div><a class="circulo icon propuestas" href="/propositions" title="Propositions"></a><h2><a href="#" rel="nofollow" title="Propositions">Propositions</a></h2></div>
		</section>
		<section class="last_post">
			<h3 class="section_title"><a href="/blog" title="Dernières informations">Dernières informations</a></h3>
			<?php if ( have_posts() ): ?>
		...
		if ($existe_evento){ ?>
			...
			<a href="/evenements" class="button" title="Voir plus d'évènements">Voir plus d'évènements</a>
		<?php } ?>
		...
		if ($existe_persona){ ?>
			<section class="last_persons clearfix">
				<h3 class="section_title"><a href="/personnes" title="Personnalités publiques">Personnalités publiques</a></h3>
				<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
			...
			<a href="/personnes" class="button" title="En voir plus">En voir plus</a>
		<?php } ?>
